...
support_vector_machine_kernels = [ ["poly-r-0", 3.0, 0.5, 0.0],
                                   ["poly-r-1", 3.0, 0.5, 1.0],
                                   ["sigmoid", 0.0, 0.5, -2.0],
                                   ["rbf", 0.0, 0.5, 0.0] ]
...
for current_support_vector_machine_kernel_index in range(len(support_vector_machine_kernels)):
    ...
    if( (current_support_vector_machine_kernel[0]=="poly-r-0") or (current_support_vector_machine_kernel[0]=="poly-r-1") ):    
        support_vector_machine_classifier = support_vector_machine(kernel="poly", degree=current_support_vector_machine_kernel[1], gamma=current_support_vector_machine_kernel[2], coef0=current_support_vector_machine_kernel[3], C=1.0)
    else:    
